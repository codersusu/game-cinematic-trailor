...
movie=ROOT/'The Last Observatory - Astra Chamber.mp4'
...
meta=next(gen);w,h=meta['size'];count=0;selected={15,82,145,224,317,331,420,540};thumbs=[]
for frame in gen:
 count+=1
...
sheet.save(ROOT/'previews/v5/final-contact-sheet.jpg',quality=94)
...
(ROOT/'renders/v5/movie-qa.json').write_text(json.dumps(report,indent=2))
