"""Reproducible cinematic environment. Blender --background --python scripts/build_scene_v3.py"""
...
def camera(name,start,end,target1,target2,lens,f1,f2,fstop=4):
 ...
 return o
camera('01 • Across the threshold',(-1.4,-1.2,2.55),(1.4,-.7,2.6),(-3.8,-5.9,1.62),(-3.8,-2.25,1.12),30,1,192,7.1)
camera('02 • The turning heavens',(-3.8,-1.9,5.9),(-3.0,-1.5,5.6),(-.2,2,3.95),(.1,2,3.95),48,193,288,5.6)
wide=camera('03 • Under a billion stars',(7.6,-12,3.3),(5.7,-10.5,3.1),(0,2,4.0),(0,2,4.25),29,289,480,8)
...
bpy.ops.wm.save_as_mainfile(filepath=str(ROOT/('observatory-v3-environment.blend' if os.environ.get('OBS_SKIP_KEEPER')=='1' else 'observatory-v3.blend')),compress=True)
