...
movie=ROOT/'The Last Observatory - Wonder.mp4'
...
sheet.save(ROOT/'previews/v4/final-contact-sheet.jpg',quality=94)
...
(ROOT/'renders/v4/movie-qa.json').write_text(json.dumps(report,indent=2))
