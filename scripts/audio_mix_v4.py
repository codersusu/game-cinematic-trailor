#!/usr/bin/env python3
"""Version 4: native Rocketbox walk synchronization with retained cinematic score.

Writes only audio/v4/. Existing v1/v2 recordings are read without modification.
...
def main():
    ...
    # Tame isolated droplet spikes and reduce weather prominence for the starry observatory setting.
    ...
    premaster=OUT/'last_observatory_v4_premaster.wav';final=OUT/'last_observatory_v4_mix.wav'
    ...
    qa={'version':4,'duration_seconds':len(finished)/SR,'sample_rate':SR,'channels':2,'encoding':'16-bit PCM WAV',
        ...
        'dialogue':False,'new_paid_api_requests':0,
