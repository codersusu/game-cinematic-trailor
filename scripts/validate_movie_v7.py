...
movie=ROOT/'The Last Observatory - Astra Approach.mp4'
...
meta=next(gen);w,h=meta['size'];count=0;selected={15,82,317,345,385,424,472,510};thumbs=[]
for frame in gen:
 count+=1
...
sheet.save(ROOT/'previews/v7/final-contact-sheet.jpg',quality=94)
...
(ROOT/'renders/v7/movie-qa.json').write_text(json.dumps(report,indent=2))
