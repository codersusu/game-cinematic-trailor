...
movie=ROOT/'The Last Observatory - Astra Reach.mp4'
...
meta=next(gen);w,h=meta['size'];count=0;selected={15,82,317,385,408,448,472,540};thumbs=[]
for frame in gen:
 count+=1
...
sheet.save(ROOT/'previews/v6/final-contact-sheet.jpg',quality=94)
...
(ROOT/'renders/v6/movie-qa.json').write_text(json.dumps(report,indent=2))
