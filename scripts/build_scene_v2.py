"""Reproducible cinematic environment. Blender --background --python scripts/build_scene_v2.py"""
...
# A young keeper makes a simple, fully grounded entrance.
keeper={}
if os.environ.get('OBS_SKIP_KEEPER')!='1':
 from young_keeper import add_young_keeper
 keeper=add_young_keeper()
...
camera('02 • The turning heavens',(-3.8,-1.9,5.9),(-3.0,-1.5,5.6),(-1.2,2,5.3),(-.8,2,5.15),65,193,288,3.8)
...
bpy.ops.wm.save_as_mainfile(filepath=str(ROOT/('observatory-v2-environment.blend' if os.environ.get('OBS_SKIP_KEEPER')=='1' else 'observatory-v2.blend')))
