...
movie=ROOT/'The Last Observatory - Arrival.mp4'
...
sheet.save(ROOT/'previews/v2/final-contact-sheet.jpg',quality=94)
...
(ROOT/'renders/v2/movie-qa.json').write_text(json.dumps(report,indent=2))
