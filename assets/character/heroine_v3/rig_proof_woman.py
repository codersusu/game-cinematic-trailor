...
out=BASE/'assets/character/heroine_v3/rig-proof-woman';out.mkdir(exist_ok=True)
...
for frame in [1,8,15,22,64,130,240,252,390]:
 ...
 if render and frame in [8]:scene.render.filepath=str(out/f'{frame:04d}.png');bpy.ops.render.render(write_still=True)
